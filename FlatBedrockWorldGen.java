			...
			for (int blockZ = 0; blockZ < 16; blockZ++) {
				if (isNether) {
					for (int blockY = 126; blockY > 121; blockY--) {
						if (world.getBlockId(chunkX * 16 + blockX, blockY,
								chunkZ * 16 + blockZ) == Block.bedrock.blockID) {
							world.setBlock(chunkX * 16 + blockX, blockY, chunkZ
									* 16 + blockZ, Block.netherrack.blockID, 0,
									2);
						}
					}
				}
				...
				for (int blockY = 5; blockY > 0; blockY--) {
					if (world.getBlockId(chunkX * 16 + blockX, blockY, chunkZ
						...
						if (isNether) {
							...
							world.setBlock(chunkX * 16 + blockX, blockY, chunkZ
									* 16 + blockZ, Block.stone.blockID, 0, 2);
						}
					}
				}
			}
